...
const scripts=[
 "validate-workspace.mjs","validate-graph-view-model.mjs","validate-source-layer.mjs","validate-orchestration.mjs","validate-semantic-lod.mjs","validate-viewer-parity.mjs",
