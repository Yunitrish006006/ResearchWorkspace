...
for(const route of ["/api/health","/api/agent-adapter","/api/graph-data","/api/repository-status","/api/claim-evidence-matrix","/api/viewer-settings","/api/activity","/api/orchestration-plan","/api/change-intelligence","/api/verification-state","/api/replay","/api/replay/frame","/api/prompt","/api/refresh","/api/conversation","/api/conversation/draft","/api/conversation/prompt","/api/conversation/status","/api/conversation/cancel"])assert.ok(source.includes(route),route);
